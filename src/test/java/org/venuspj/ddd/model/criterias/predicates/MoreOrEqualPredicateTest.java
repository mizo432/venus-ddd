...
class MoreOrEqualPredicateTest {
    @Test
    @Tag("small")
    public void test1() {
        //given
        ...
        //when
        boolean actual = MoreOrEqualPredicate.of(BigDecimal.ONE).test(arg);
        //then
        assertThat(actual)
                .isTrue();
    ...
    public void test5() {
        ...
        BigDecimal arg = BigDecimal.ONE;
        //when
        boolean actual = MoreOrEqualPredicate.of((BigDecimal) null).test(arg);
        //then
        assertThat(actual)
                .isTrue();
