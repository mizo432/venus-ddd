...
public class YearMonthIntervalTest {
    ...
    public void createFrom() {
        ...
        YearMonthInterval target
                = YearMonthInterval
                .createFrom(
                        StartYearMonth.of(YearMonth.of(2017, 1))
                        , EndYearMonth.of(YearMonth.of(2020, 12)));
    ...
    public void contains1() {
        ...
        TargetYearMonth targetMoment = TargetYearMonth.of(YearMonth.of(2018, 3));

        boolean actual = target.contains(targetMoment);
