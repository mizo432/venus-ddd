 ...
 * @param <AE> エンティティリスト
 */
public abstract class AbstractEntities<E extends AbstractEntity<E, EI>, EI extends EntityIdentifier<EI>, AE extends AbstractEntities<E, EI, AE>> extends AbstractListValue<E, AE> {
