...
public class DateTimeInterval implements Value<DateTimeInterval> {
    ...
    private static class DefaultDateTimeValue extends AbstractDateTimeValue<DefaultDateTimeValue> {
        ...
        public boolean isAfter(TargetDateTime aTargetMoment) {
            return value.isAfter(aTargetMoment.getValue());

        }

        public boolean sameMoment(TargetDateTime aTargetMoment) {
            return value.equals(aTargetMoment.getValue());
        }


        public boolean isBefore(TargetDateTime aTargetMoment) {
